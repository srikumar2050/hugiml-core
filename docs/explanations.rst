...
When the fitted downstream estimator is RPTE-based (see :doc:`tuning`), use the flat-tree API for readable review and the table API for structured analysis:

.. code-block:: python

   print(clf.rpte_rule_tree())
