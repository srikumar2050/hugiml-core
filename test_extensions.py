...
class TestPruning:
    ...
    def test_calibrate(self, fitted_clf):
        ...
        # sklearn 1.6+ emits a deprecation warning for CalibratedClassifierCV(cv="prefit").
        # Calibration behavior is covered by this test; the third-party warning is not.
        with warnings.catch_warnings():
            warnings.filterwarnings(
                "ignore",
                message=".*cv='prefit'.*deprecated.*",
