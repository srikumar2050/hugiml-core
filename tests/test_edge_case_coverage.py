...
"""Boundary-condition and edge-case coverage across several subsystems:
adaptive-binning helpers, calibration, governance-artifact generation,
telemetry (including its error paths), serialization helpers, and
classifier private helper methods. Each class targets one subsystem's
less-common inputs (empty data, degenerate distributions, disabled
telemetry, malformed pickled state, and similar) rather than its everyday
path, which is covered elsewhere.
"""
